...
- (void)viewDidLoad
{
    ...
    self.tableView.tableHeaderView = ({
        ...
        imageView.image = [UIImage imageNamed:@"abcd.jpg"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 0 && indexPath.row == 0) {
       ...
       DEMOHomeViewController *secondViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"secondController"];
